...
function EditorPage() {
    ...
    return (
      <>
        ...
        <div className="p-8 text-muted-foreground">
          No resume yet. Create one from the Dashboard.
        </div>
      </>
    );
  }
                      ...
                      {d.personal.avatar && (
                        <Button
                          ...
                          onClick={() =>
                            setD((dd) => ({
                              ...dd,
                              personal: { ...dd.personal, avatar: undefined },
                            }))
                          }
                        >
                ...
                {(
                  ...
                  <div key={k} className="space-y-1.5">
                    ...
                    <Input
                      value={d.personal[k] ?? ""}
                      onChange={(e) =>
                        setD((dd) => ({ ...dd, personal: { ...dd.personal, [k]: e.target.value } }))
                      }
                    />
                  </div>
                ))}
            ...
            <TabsContent value="summary" className="mt-4">
              <Card className="p-5 space-y-2">
                ...
                <Textarea
                  rows={6}
                  value={d.summary}
                  onChange={(e) => setD((dd) => ({ ...dd, summary: e.target.value }))}
                />
                <p className="text-xs text-muted-foreground">
                  Tip: write 2–4 sentences highlighting your core skills and goals.
                </p>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="education" className="mt-4 space-y-3">
              {d.education.map((e, i) => (
                <Card key={e.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({ ...dd, education: dd.education.filter((_, j) => j !== i) }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                    <Field
                      label="School"
                      v={e.school}
                      on={(v) => upd("education", i, "school", v)}
                    />
                    <Field label="Major" v={e.major} on={(v) => upd("education", i, "major", v)} />
                    <Field
                      label="Start year"
                      v={e.startYear}
                      on={(v) => upd("education", i, "startYear", v)}
                    />
                    <Field
                      label="End year"
                      v={e.endYear}
                      on={(v) => upd("education", i, "endYear", v)}
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Textarea
                      rows={2}
                      value={e.description}
                      onChange={(ev) => upd("education", i, "description", ev.target.value)}
                    />
                  </div>
                </Card>
              ))}
            ...
            <TabsContent value="skills" className="mt-4 space-y-3">
              {d.skills.map((s, i) => (
                <Card key={s.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({ ...dd, skills: dd.skills.filter((_, j) => j !== i) }))
                    }
                  />
                  <Field
                    label="Category"
                    v={s.category}
                    on={(v) => upd("skills", i, "category", v)}
                  />
                  <div className="space-y-1.5">
                    <Label>Skills (comma-separated)</Label>
                    <Input
                      value={s.items}
                      onChange={(e) => upd("skills", i, "items", e.target.value)}
                    />
                  </div>
                </Card>
              ))}
              <Button
                ...
                onClick={() =>
                  setD((dd) => ({
                    ...dd,
                    skills: [...dd.skills, { id: uid(), category: "", items: "" }],
                  }))
                }
              >
            ...
            <TabsContent value="projects" className="mt-4 space-y-3">
              {d.projects.map((p, i) => (
                <Card key={p.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({ ...dd, projects: dd.projects.filter((_, j) => j !== i) }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                    <Field
                      label="Project name"
                      v={p.name}
                      on={(v) => upd("projects", i, "name", v)}
                    />
                    <Field label="Role" v={p.role} on={(v) => upd("projects", i, "role", v)} />
                    <Field
                      label="Tech stack"
                      v={p.techStack}
                      on={(v) => upd("projects", i, "techStack", v)}
                    />
                    <Field
                      label="GitHub"
                      v={p.github}
                      on={(v) => upd("projects", i, "github", v)}
                    />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Textarea
                      rows={4}
                      value={p.description}
                      onChange={(e) => upd("projects", i, "description", e.target.value)}
                    />
                  </div>
                </Card>
              ))}
            ...
            <TabsContent value="experience" className="mt-4 space-y-3">
              {d.experience.map((e, i) => (
                <Card key={e.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({ ...dd, experience: dd.experience.filter((_, j) => j !== i) }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                    <Field
                      label="Company"
                      v={e.company}
                      on={(v) => upd("experience", i, "company", v)}
                    />
                    <Field
                      label="Position"
                      v={e.position}
                      on={(v) => upd("experience", i, "position", v)}
                    />
                    <Field
                      label="Start date"
                      v={e.startDate}
                      on={(v) => upd("experience", i, "startDate", v)}
                    />
                    <Field
                      label="End date"
                      v={e.endDate}
                      on={(v) => upd("experience", i, "endDate", v)}
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label>Description (each line = one bullet)</Label>
                    <Textarea
                      rows={3}
                      value={e.description}
                      onChange={(ev) => upd("experience", i, "description", ev.target.value)}
                    />
                  </div>
                </Card>
              ))}
                ...
                <Card key={c.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({
                        ...dd,
                        certificates: dd.certificates.filter((_, j) => j !== i),
                      }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                    <Field
                      ...
                      v={c.name}
                      on={(v) => upd("certificates", i, "name", v)}
                    />
                    <Field
                      label="Issuer"
                      v={c.issuer}
                      on={(v) => upd("certificates", i, "issuer", v)}
                    />
            ...
            <TabsContent value="languages" className="mt-4 space-y-3">
              {d.languages.map((l, i) => (
                <Card key={l.id} className="p-5 space-y-3">
                  <RowActions
                    onDelete={() =>
                      setD((dd) => ({ ...dd, languages: dd.languages.filter((_, j) => j !== i) }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
              ...
              <Button
                ...
                onClick={() =>
                  setD((dd) => ({
                    ...dd,
                    languages: [...dd.languages, { id: uid(), name: "", level: "" }],
                  }))
                }
              >
                <Plus /> Add Language
  ...
  function upd<
    K extends "education" | "skills" | "projects" | "experience" | "certificates" | "languages",
